...
public class CreateUser {	
	...
	public void insert(String firstName, String lastName, String email, String password, String univid, String uniquecode) {
  ...
  System.out.println("cufn"+email);
	...
	public User getObjectByEmail(String email){
	    ...
	    User user = new User();
	    String userid = null;
		userid=entitymanager.createQuery("SELECT u.userid FROM User u WHERE u.email ='"+ email +"'").getSingleResult().toString();
		if(userid==null)
			return null;
